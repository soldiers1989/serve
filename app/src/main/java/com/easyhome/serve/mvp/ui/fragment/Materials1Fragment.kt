...
import com.easyhome.serve.di.component.DaggerMaterials1Component
 ...
 * d
 */
class Materials1Fragment : BaseFragment<Materials1Presenter>(), Materials1Contract.View {
    companion object {
        fun newInstance(): Materials1Fragment {
            val fragment = Materials1Fragment()
            return fragment
        }
    }
    ...
    override fun setupFragmentComponent(appComponent: AppComponent) {
        DaggerMaterials1Component //如找不到该类,请编译一下项目
            .builder()
            .appComponent(appComponent)
            .materials1Module(Materials1Module(this))
            .build()
            .inject(this)
    }

    override fun initView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        return inflater.inflate(R.layout.fragment_materials1, container, false);
    }
